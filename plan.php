			...
			<form action="" id="manage-plan">
				<div class="card">
					<div class="card-header">
						   Review/Add New Loan Plan
				  	</div>
					<div class="card-body">
							<input type="hidden" name="id">
							<div class="form-group">
								<label class="control-label">Plan (weeks)</label>
								<input type="number" name="weeks" id="" class="form-control text-right">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="control-label">weekly Over due's Penalty</label>
								<div class="input-group">
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								while($row=$plan->fetch_assoc()):
									...
									$weeks = $weeks / 48;
									if($weeks < 1){
										$weeks = $row['weeks']. " weeks";
									}else{
										$m = explode(".", $weeks);
										$weeks = $m[0] . " yrs.";
										if(isset($m[1])){
											$weeks .= " and ".number_format(12 * ($m[1] /100 ),0)."week/s";
										}
									}
								?>
								<tr>
									...
									<td class="">
										 <p>Years/week: <b><?php echo $weeks ?></b></p>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_plan" type="button" data-id="<?php echo $row['id'] ?>" data-weeks="<?php echo $row['weeks'] ?>" data-interest_percentage="<?php echo $row['interest_percentage'] ?>" >Edit</button>
...
<script>
	...
	$('.edit_plan').click(function(){
		...
		plan.find("[name='weeks']").val($(this).attr('data-weeks'))
