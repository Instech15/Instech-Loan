...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				<table style="width:1200px" class="table table-bordered" id="loan-list">
					<colgroup>
						<col width="1%">
						<col width="15%">
						<col width="15%">
					...
					<tbody>
						<?php
							...
							$plan = $conn->query("SELECT *,concat(weeks,' week/s [ ',interest_percentage,'%, ',penalty_rate,' ]') as plan FROM loan_plan where id in (SELECT plan_id from loan_list) ");
							...
							while($row = $qry->fetch_assoc()):
								$weekly = ($row['amount'] + ($row['amount'] * ($plan_arr[$row['plan_id']]['interest_percentage']/100))) / $plan_arr[$row['plan_id']]['weeks'];
								$penalty = $weekly * ($plan_arr[$row['plan_id']]['penalty_rate']/100);
						 ...
						 <tr>
						 	...
						 	<td>
						 		<p style="width:200px;">Name :<b><?php echo $row['name'] ?></b></p>
						 		<p style="width:200px;"><small>Contact # :<b><?php echo $row['contact_no'] ?></small></b></p>
						 		<p style="width:200px;"><small>Address :<b><?php echo $row['address'] ?></small></b></p>
						 	</td>
						 	<td>
						 		<p style="width:200px;">Reference No. :<b><?php echo $row['ref_no'] ?></b></p>
						 		<p style="width:200px;"><small>Loan type :<b><?php echo $type_arr[$row['loan_type_id']] ?></small></b></p>
						 		<p style="width:200px;"><small>Plan :<b><?php echo $plan_arr[$row['plan_id']]['plan'] ?></small></b></p>
						 		<p style="width:200px;"><small>Amount :<b><?php echo $row['amount'] ?></small></b></p>
						 		<p style="width:200px;"><small>Total Payable Amount :<b><?php echo number_format($weekly * $plan_arr[$row['plan_id']]['weeks'],2) ?></small></b></p>
						 		<p style="width:200px;"><small>weekly Payable Amount: <b><?php echo number_format($weekly,2) ?></small></b></p>
						 		<p style="width:200px;"><small>Overdue Payable Amount: <b><?php echo number_format($penalty,2) ?></small></b></p>
						 	...
						 	<td>
						 		...
						 		<p><small>weekly amount:<b><?php echo number_format($weekly,2) ?></b></small></p>
						 		<p><small>Penalty :<b><?php echo $add = (date('Ymd',strtotime($next)) < date("Ymd") ) ?  $penalty : 0; ?></b></small></p>
						 		<p><small>Payable Amount :<b><?php echo number_format($weekly + $add,2) ?></b></small></p>
						 		<?php else: ?>
					 				N/a
						 		<?php endif; ?>
						 	</td>
							...
							<td><?php echo $row['pbook'] ?></td>
							<td><?php echo $row['lform'] ?></td>
