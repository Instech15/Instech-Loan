...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=expenses" class="nav-item nav-plan"><span class='icon-field'><i class="fa fa-file-invoice-dollar"></i></span> Expenses</a>
				<a href="index.php?page=report_payment" class="nav-item nav-loan_type"><span class='icon-field'><i class="fa fa-file-invoice"></i></span> Payment Reports</a>
				<a href="index.php?page=report_charges" class="nav-item nav-loan_type"><span class='icon-field'><i class="fa fa-file-invoice"></i></span> Charges Reports</a>
				<a href="index.php?page=report_expenses" class="nav-item nav-loan_type"><span class='icon-field'><i class="fa fa-file-invoice"></i></span> Expenses Reports</a>
